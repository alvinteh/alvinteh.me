...
import { PageTitle, ParallaxPageWrapper, ParallaxScreen, cubicBezier, pageTransitionDuration } from '../../components/static';
...
const Culinary = () => {
  return (
    <ParallaxPageWrapper>
      ...
      <ParallaxScreen $backgroundImage={FineDiningScreenBackground}>
