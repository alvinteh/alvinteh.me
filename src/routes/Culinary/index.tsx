...
import CookHeader1Svg from './images/cook-header-1.svg?react';
import CookHeader2Svg from './images/cook-header-2.svg?react';
import CookHeader3Svg from './images/cook-header-3.svg?react';
import CookHeader4Svg from './images/cook-header-4.svg?react';
...
const CookHeader1 = styled(CookHeader1Svg)`
  position: absolute;
  top: 40vh;
  left: 50%;
  margin-left: -15vw;
...
const CookHeader2 = styled(CookHeader2Svg)`
  position: absolute;
  top: 40vh;
  left: 50%;
  margin-left: -30vw;
...
const CookHeader3 = styled(CookHeader3Svg)`
  position: absolute;
  top: 40vh;
  left: 50%;
  margin-left: -15vw;
...
const CookHeader4 = styled(CookHeader4Svg)`
  position: absolute;
  top: 40vh;
  left: 50%;
  margin-left: -31vw;
...
const Culinary = () => {
  ...
  return (
    <ParallaxPageWrapper>
      ...
      >
        <CookHeader1 ref={cookHeader1Ref} />
        <CookHeader2 ref={cookHeader2Ref} />
        <CookDishes ref={cookDishesRef}>
          {cookDishElements}
        </CookDishes>
        <CookHeader3 ref={cookHeader3Ref} />
        <CookHeader4 ref={cookHeader4Ref} />
      </ParallaxScreen>
      <ScrollPrompt />
    </ParallaxPageWrapper>
  );
